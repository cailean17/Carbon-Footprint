...
def homepage():
    if request.method == 'POST':
      """results = {"Homepage": "This is the <a href='/'>homepage</a> for this website with a map that have pollution level.", 
                 "Map": "Map is showing on the <a href='/'>homepage</a>. With pollution level",
                 "Register": "<a href='/register'>Register</a> an account is nesscary if you want to access some service.", 
                 "Carbon Footprint": ""}"""
      pass
    else:
